...
namespace RogueDefense
{
    public class ShootManager
    {
        ...
        {
            this.player = player;
            baseDamage = 1f + player.upgradePoints[0] * UpgradeContainer.STAT_PER_POINT[0];
            baseShootInterval = 1f / (1f + player.upgradePoints[1] * UpgradeContainer.STAT_PER_POINT[1]);
            baseMultishot = 1f + player.upgradePoints[2] * UpgradeContainer.STAT_PER_POINT[2];
        }
